...
# lib.bible.generate_chapters(df_chapters=df_chapters, con=con, words=words)
# lib.bible.generate_chapters(df_chapters=df_chapters[0:2], con=con, words=words)
# lib.bible.generate_toc(df_chapters=df_chapters, con=con)
df_words = lib.database.get_table(con=con, table=lib.globals.db_words)
lib.bible.generate_words(df_words=df_words[4427:], con=con)
